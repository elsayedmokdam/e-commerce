...
/**
 * Truncates a given title to a maximum length of 30 characters.
 * If the title is longer than the maximum length, it appends "..." to the end.
...
export default function ProductCard({ product }: { product: ProductData }) {
  return (
    <div
      key={product.id}
      className="group bg-white rounded-lg border border-gray-100 hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col"
    >
      {/* Product Image Container */}
      <div className="relative overflow-hidden bg-gray-50 aspect-square md:aspect-video lg:aspect-square flex items-center justify-center">
        {/* Discount Badge */}
        ...
        <Image
          ...
          width={400}
          height={400}
          className="object-contain w-full h-full p-4 group-hover:scale-120 transition-transform duration-300 rounded-t-4xl"
        />
      ...
      <div className="p-3 md:p-4 grow flex flex-col justify-between">
        ...
        <AppButton
          variant="default"
          size="default"
          className="w-full flex items-center justify-center gap-2 text-xs md:text-sm bg-main-color hover:bg-teal-600 transition-colors text-white rounded-full py-2 md:py-3 cursor-pointer"
        >
